      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-24">
          ...
          <div className="space-y-8">
            <div className="flex items-center gap-6 group">
              ...
              <div>
                ...
                <p className="text-lg">+44 (0) 7797 746 746</p>
              </div>
            </div>
            ...
            <div className="pt-8 border-t border-brand-ink/5">
              <div className="flex items-start gap-4 text-brand-muted text-sm leading-relaxed">
                ...
                <p>I respect your privacy and operate with the discretion of a sealed vault. Your information is only used to respond to your inquiry and will never be shared with third parties.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="lg:w-2/3 bg-brand-cream p-12 md:p-16 rounded-[40px]">
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="space-y-3">
              <label htmlFor="message" className="text-xs uppercase tracking-widest font-semibold ml-1">How can I help?</label>
              <textarea 
                id="message" 
                name="message" 
                rows={5} 
